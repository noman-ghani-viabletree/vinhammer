...
class wpDiscuzFCommentOption {
    ...
    public function __construct() {
        ...
        add_filter("wpdiscuz_settings", [&$this, "settingsArray"], 60);
        $this->addOptions();
        $this->initOptions();
    }
    ...
    public function initOptions() {
        ...
        $this->optionType = wp_unslash(array_filter($options["optionType"]));
    ...
    public function saveOptions() {
        if ($this->tabKey === $_POST["wpd_tab"]) {
            ...
            $this->reportedMailMessage = isset($_POST[$this->tabKey]["reportedMailMessage"]) ? wp_unslash($_POST[$this->tabKey]["reportedMailMessage"]) : __("You have a new [status] comment on the post [postTitle].<br>\n[postName]<br>\n<b>Comment details:</b><br>\n Author: [userLogin]<br>\n Email: [userEmail]<br>\n URL:<br>\n Comment:\n [commentContent]", "wpdiscuz_fc");
            ...
            $this->optionType = isset($_POST[$this->tabKey]["optionType"]) ? wp_unslash(array_filter($_POST[$this->tabKey]["optionType"])) : [__("This comment is spam", "wpdiscuz_fc"), __("This comment should be marked mature", "wpdiscuz_fc"), __("This comment is abusive", "wpdiscuz_fc"), __("This comment promotes self-harm", "wpdiscuz_fc")];
